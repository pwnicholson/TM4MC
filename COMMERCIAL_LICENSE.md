...
- Providing hosted access (SaaS) where users pay to access the tool.

## Examples that do NOT require a Commercial License
- Personal use.
- Free community use.
- Free distribution of source code and non-commercial forks under the Non-Commercial Public License.
- Content creators using the tool in monetized videos/streams, as long as they do not sell access to the tool or charge others to use it.
...
Commercial licensing terms may include one-time fees, recurring fees, or other arrangements, depending on usage.

(If this repo has an Issues page enabled, you may also open an issue labeled “commercial licensing” and request contact.)
